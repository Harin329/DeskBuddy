...
export const SET_FLOOR_IN_UPDATE = "SET_FLOOR_IN_UPDATE";
export const SET_EMPLOYEES = "SET_EMPLOYEES";
export const SET_CONFIRM_DELETE_POPUP = "SET_CONFIRM_DELETE_POPUP";
export const SET_CONFIRM_UPDATE_POPUP = "SET_CONFIRM_UPDATE_POPUP";
export const SET_EDITS_IN_UPDATE = "SET_EDITS_IN_UPDATE";
export const SET_DESKS_IN_UPDATE = "SET_DESKS_IN_UPDATE";
export const SET_FORMATTED_RESERVATIONS = "SET_FORMATTED_RESERVATIONS";
